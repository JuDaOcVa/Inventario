...
ALTER TABLE ONLY public.tokens
    ADD CONSTRAINT tokens_users_id_fk FOREIGN KEY (id_user) REFERENCES public.users(id);
...
INSERT INTO public.states (id, description) VALUES (1, 'ACTIVE'), (2, 'INACTIVE'), (3, 'DELETED');
